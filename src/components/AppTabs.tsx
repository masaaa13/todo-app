...
export type AppTab = 'tasks' | 'products' | 'wishlist' | 'budget' | 'inventory' | 'schedules' | 'import' | 'settings';
...
const TABS: AppTab[] = ['tasks', 'products', 'wishlist', 'budget', 'inventory', 'schedules', 'import', 'settings'];
